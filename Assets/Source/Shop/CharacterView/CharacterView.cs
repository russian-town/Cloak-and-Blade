...
using Source.Root;
using Source.Shop.Character.Animations;
...
namespace Source.Shop.CharacterView
{
    public class CharacterView : MonoBehaviour
    {
        ...
        public event Action<Character.Character, CharacterView> SellButtonClicked;

        public event Action<Character.Character, CharacterView> SelectButtonClicked;
        ...
        private void OnEnable()
        {
            ...
            _sellButton.onClick.AddListener(LockBuyCharacter);
            _selectButton.onClick.AddListener(() => SelectButtonClicked?.Invoke(_character, this));
            _selectButton.onClick.AddListener(LockSelectCharacter);
        ...
        private void OnDisable()
        {
            ...
            _sellButton.onClick.RemoveListener(LockBuyCharacter);
            _selectButton.onClick.RemoveListener(() => SelectButtonClicked?.Invoke(_character, this));
            _selectButton.onClick.RemoveListener(LockSelectCharacter);
            _descriptionButton.onClick.RemoveListener(OnDescriptionButtonClicked);
            _upgradeButton.onClick.RemoveListener(OnUpgradeButtonClicked);
        }

        public void Render(Character.Character character, Description description, Wallet wallet, UnityEngine.Camera camera)
        {
        ...
        private void LockSelectCharacter()
        {
